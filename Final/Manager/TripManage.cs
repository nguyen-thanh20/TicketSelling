...
namespace Manager
{
    public partial class TripManage : Form
    {
        SqlConnection con;
        SqlCommand cmd;
        SqlDataAdapter dap;
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                textBox18.Text = dataGridView1[13, e.RowIndex].Value.ToString();
            }
            catch (Exception ex)
            {
            }
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            {
                errChitiet.SetError(textBox18, "Blank");
                return;
            }
            else
            {
            ...
            sql = "INSERT INTO TRIP(Source, Destination, Date_Trip,Start_Time,Arrival_Time, Total_Seat, Price, Discount, ID_Driver,Duration, Available_Seat, ID_Manager) VALUES (";
            sql += "'" + textBox5.Text + "','" + textBox6.Text + "','" + dateTimePicker1.Value.Date + "','"+textBox3.Text+ "','"+textBox4.Text+ "',"+textBox8.Text+ ","+textBox9.Text+ ","+ textBox10.Text+ ",'"+textBox11.Text+"','"+textBox16.Text+"','"+textBox17.Text+"','"+textBox18.Text+"');";
