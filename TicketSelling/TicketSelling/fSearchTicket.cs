...
namespace TicketSelling
{
    public partial class fSearchTicket : Form
    {
        ...
        void LoadTicket (string idTicket)
        {
            ...
            btn.Text = "ID Ticket: " + ticket.IdTicket + Environment.NewLine + Environment.NewLine + "Source: " + trip.Source + Environment.NewLine + Environment.NewLine + "Destination: " + trip.Destination + Environment.NewLine + Environment.NewLine + "Start Day: " + trip.Date
                ...
                + "Discount: " + trip.Discount + "%" + Environment.NewLine + Environment.NewLine + "Total Price: " + (trip.Price + trip.Price * trip.Discount) + "£" + Environment.NewLine + Environment.NewLine + "Seat Number: " + ticket.SeatNumber;
